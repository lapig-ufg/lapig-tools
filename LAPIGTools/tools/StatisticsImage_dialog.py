...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'StatisticsImage_dialog_base.ui'))


class StatisticsImageDialog(QtGui.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(StatisticsImageDialog, self).__init__(parent)
